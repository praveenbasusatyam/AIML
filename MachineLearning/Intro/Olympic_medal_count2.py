...
def avg_medal_count():
    ...
    # YOUR CODE HERE
    df_atleast_one_gold = df[df['gold'] >= 1]
    print df_atleast_one_gold
    print ""

    #
    avg_least_one_gold = DataFrame(df_atleast_one_gold['bronze'])
    print avg_least_one_gold
    print ""

    #
    avg_bronze_at_least_one_gold = avg_least_one_gold.apply(numpy.mean)
